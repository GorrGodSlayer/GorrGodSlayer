...
I am not fancy, or a content creator, or anyone of notice really.  

I create code for people, sometimes i get in trouble for it, other times i get paid really well.

# Languages, Tools and programs i can use

Below is a list of programming languages, softwares and tools i know how to use:  
  
Python, Bash, PowerShell, C, JavaScript, PHP, SQL, Go, Ruby, Java, Assembly, Rust, TypeScript, Groovy, Kotlin, Swift, GDScript
